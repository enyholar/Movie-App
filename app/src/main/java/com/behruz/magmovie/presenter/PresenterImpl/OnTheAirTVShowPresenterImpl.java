...
public class OnTheAirTVShowPresenterImpl implements OnTheAirTVShowPresenter {
    private OnTheAirTvShowView mView;
    ...
    @Override
    public void setView(@NonNull OnTheAirTvShowView view) {
        this.mView = view;
    }
...
// Call any of the available endpoints
                try {
                    Response<TvShowResultsPage> response = tvService.onTheAir(page,"en-US"
                    ).execute();
