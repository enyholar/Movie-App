...
import com.behruz.magmovie.presenter.PresenterView.OnAiringTvShowView;
...
public class OnAiringTVShowPresenterImpl implements OnAiringTVShowPresenter {
    private OnAiringTvShowView mView;
    ...
    @Override
    public void setView(@NonNull OnAiringTvShowView view) {
        this.mView = view;
    }
    ...
    @Override
    public void loadOnAiringTvShowList(final int page, boolean isRefresh) {
...
// Call any of the available endpoints
                try {
                    Response<TvShowResultsPage> response = tvService.airingToday(page,"en-US"
                    ).execute();
