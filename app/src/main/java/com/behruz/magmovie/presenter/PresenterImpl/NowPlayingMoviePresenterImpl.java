...
public class NowPlayingMoviePresenterImpl implements NowPlayingMoviePresenter {
    private NowPlayingMovieListView mView;
    ...
    @Override
    public void setView(@NonNull NowPlayingMovieListView view) {
        this.mView = view;
    }
    ...
    @Override
    public void loadNowPlayingMovieList(final int page,boolean isRefresh) {
...
// Call any of the available endpoints
                try {
                    Response<MovieResultsPage> response = moviesService.nowPlaying(page,"en-US").execute();
