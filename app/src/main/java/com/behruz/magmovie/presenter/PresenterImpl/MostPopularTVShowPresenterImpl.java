...
public class MostPopularTVShowPresenterImpl implements MostPopularTVShowPresenter {
    private MostPopularTvShowView mView;
    ...
    @Override
    public void setView(@NonNull MostPopularTvShowView view) {
        this.mView = view;
    }
    ...
    @Override
    public void loadTvShowList(final int page,boolean isRefresh) {
...
// Call any of the available endpoints
                try {
                    Response<TvShowResultsPage> response = tvService.popular(page,"en-US"
                    ).execute();
