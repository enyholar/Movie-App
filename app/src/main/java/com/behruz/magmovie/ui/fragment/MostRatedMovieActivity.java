...
public class MostRatedMovieActivity extends BaseActionbarActivity implements MostRatedMovieListView, MovieListAdapter.OnMovieItemSelectedListener {
    @Inject
    MostRatedMoviePresenter presenter;
...
//    public MostRatedMovieActivity() {
//        // Required empty public constructor
//    }
//
//
//    public static MostRatedMovieActivity newInstance() {
//        MostRatedMovieActivity fragment = new MostRatedMovieActivity();
...
//        rvMovies.setAdapter(movieListAdapter);
        ...
        loadOfflineData();
        presenter.loadRatedMovieList(page,false);
    }
    private void  loadOfflineData(){

        if (preferenUtil.getTrendingMovieList() != null && preferenUtil.getTrendingMovieList().size() >0){
            movieListAdapter.addAll(preferenUtil.getTrendingMovieList());
        }
    ...
    private void refreshData() {
        ...
        removeScroll();
        addScroll();
        presenter.loadRatedMovieList(page,true);
    }
