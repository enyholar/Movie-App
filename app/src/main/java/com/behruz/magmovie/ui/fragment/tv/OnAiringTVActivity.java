...
public class OnAiringTVActivity extends BaseActionbarActivity implements OnAiringTvShowView, TvListAdapter.OnMovieItemSelectedListener {
    private String json;
    @Inject
    OnAiringTVShowPresenter presenter;
