...
import com.behruz.magmovie.ui.activity.MainActivity;
...
public class OnBoardingActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        preferenUtil.enableSkipLanguage(true);
        ...
        mAdapter = new OnBoard_Adapter(this, onBoardItems, new OnBoardListner() {
            @Override
            public void ItemClick(OnBoardItem model, int pos) {
                if (pos == 2) {
                    Intent intent = new Intent(OnBoardingActivity.this, MainActivity.class);
                    startActivity(intent);
                    finish();
                } else if (pos == 1) {
                    onboard_pager.setCurrentItem(2);
                } else if (pos == 0) {
                    onboard_pager.setCurrentItem(1);
                }
            }
        });
    ...
    public void loadData() {
        ...
        int[] desc = {R.string.next, R.string.next, R.string.get_started};
        int[] imageId = {R.drawable.ic_walkthrough1, R.drawable.ic_walkthrough2, R.drawable.ic_walkthrough3};
