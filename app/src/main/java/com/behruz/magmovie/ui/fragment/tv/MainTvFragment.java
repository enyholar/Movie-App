...
public class MainTvFragment extends Fragment {
    ...
    private static final String[] tabArray = {"On the Air", "Airing Today", "Top Rated", "Popular"};//Tab title array
...
//        adapter.addFragment(new OnTheAirTVActivity(), this.getString(R.string.on_the_air));
//        adapter.addFragment(new OnAiringTVActivity(), this.getString(R.string.airing_today));
//      //  adapter.addFragment(new MostRatedMovieActivity(), this.getString(R.string.top_Rated));
//        adapter.addFragment(new MostPopularTVActivity(), this.getString(R.string.popular));
